...
int init_Cam(string fileName)
{
	dllHandle_Cam = LoadLibraryA((char*)fileName.c_str());
	if (dllHandle_Cam != NULL)
	{
		...
		MessageBox(NULL, L"dLL 版本不对", L"ERROR", MB_OK);
		return -1;
	}
	MessageBox(NULL, L"dLL 加载失败", L"ERROR", MB_OK);
	return -1;
}
...
CCamera_MFCDlg::CCamera_MFCDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCamera_MFCDlg::IDD, pParent)
{
...
// CCamera_MFCDlg 消息处理程序

BOOL CCamera_MFCDlg::OnInitDialog()
{
...
void CCamera_MFCDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CCamera_MFCDlg::OnQueryDragIcon()
{
...
void CCamera_MFCDlg::OnBnClickedOpencamera()
{
	// TODO:  在此添加控件通知处理程序代码
